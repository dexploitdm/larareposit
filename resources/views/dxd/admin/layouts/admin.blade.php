...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{ asset(env('THEMEA')) }}/assets/images/logo.svg" width="48" height="48" alt="Oreo"></div>
        <p>Please wait...</p>
    </div>
</div>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar2.jpg" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar3.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar4.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar5.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar6.jpg" alt="">
                                    <div class="media-body">
                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-primary">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        ...
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar2.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar3.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar4.jpg" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </a>
                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-info">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small class="text-muted">Team</small></li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar10.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar9.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar8.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar7.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar6.jpg" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </a>
                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-warning">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small class="text-muted">Team</small></li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar5.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar2.jpg" alt="Avatar">
                                        </li>
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar1.jpg" alt="">
                                    <div class="media-body">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar10.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar7.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar8.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar9.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar4.jpg" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar5.jpg" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar6.jpg" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar7.jpg" alt="">
                            <div class="sl-content">
            ...
            <div class="chat-widget">
                <ul class="chat-scroll-list clearfix">
                    <li class="left float-left">
                        <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar3.jpg" class="rounded-circle" alt="">
                        <div class="chat-info">
                    ...
                    <li class="left float-left"> <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                    ...
                    <li class="left float-left"> <img src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar1.jpg" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="card tasks_report">
                            ...
                            <div class="body text-center">
                                ...
                                <input type="text" class="knob dial1" value="66" data-width="100" data-height="100" data-thickness="0.1" data-bgcolor="#454e57" data-fgColor="#8c99e0" readonly>
                                <h6 class="m-t-20">Satisfaction Rate</h6>
                                <small class="displayblock">47% Average <i class="zmdi zmdi-trending-up"></i></small>
                                <div class="sparkline m-t-20" data-type="bar" data-width="97%" data-height="35px" data-bar-Width="2" data-bar-Spacing="8" data-bar-Color="#ccc">3,2,6,5,9,8,7,8,4,5,1,2,9,5,1,3,5,7,4,6</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="city-selected body l-khaki">
                        <div class="row">
                            ...
                            <div class="icon col-5">
                                <img src="{{ asset(env('THEMEA')) }}/assets/images/weather/summer.svg" alt="">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="carousel-item text-center active">
                                <div class="col-12">
                                    <ul class="row days-list list-unstyled">
                                        <li class="day col-4">
                                            <p>Monday</p>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/weather/rain.svg" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Tuesday</p>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/weather/cloudy.svg" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Wednesday</p>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/weather/wind.svg" alt="">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="carousel-item text-center">
                                <div class="col-12">
                                    <ul class="row days-list list-unstyled">
                                        <li class="day col-4">
                                            <p>Thursday</p>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/weather/sky.svg" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Friday</p>
                                            <img src="{{ asset(env('THEMEA')) }}/assets/images/weather/cloudy.svg" alt="">
                ...
                <div class="card">
                    ...
                    <div class="body table-responsive members_profiles">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar1.jpg" alt="user" width="40"> </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar2.jpg" alt="user" width="40"> </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar3.jpg" alt="user" width="40"> </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar4.jpg" alt="user" width="40"> </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="{{ asset(env('THEMEA')) }}/assets/images/xs/avatar5.jpg" alt="user" width="40"> </td>
                                <td>
